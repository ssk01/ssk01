...
| [cpp](2026/cpp/) | C++ | C++ 手动实现 StringView/PinnableView (RocksDB 风格零拷贝)、Optional (union 存储 + placement new)、Cleanable 清理链源码分析、Uniqlo (手写 unique_ptr)、Tuple (手写 std::tuple, EBO 压缩) |
