...
|---------|----------|-------------|
| [tensorflow/two_tower_demo](2026/tensorflow/two_tower_demo/) | Python | TF SavedModel 内部原理 — checkpoint vs saved_model 格式对比、GraphDef/Function 两层结构、38-op 推理 DAG 标注 |
